...
function listNewDownloads()
{
    ...
    if ($numrows>0) {
        while(list($lid, $cid, $title, $url, $homepage, $version, $size, $platform, $logourl, $uid) = $xoopsDB->fetchRow($result)) {
            ...
            echo "</td></tr>\n";
            echo "<tr><td align=\"right\" nowrap=\"nowrap\">"._MD_FILETITLE."</td><td>";
            echo "<input type=\"text\" name=\"title\" size=\"50\" maxlength=\"100\" value=\"$title\" />";
            echo "</td></tr><tr><td align=\"right\" nowrap=\"nowrap\">"._MD_DLURL."</td><td>";
            ...
            echo "</td></tr>\n";
            echo "<tr><td align=\"right\" nowrap=\"nowrap\">"._MD_HOMEPAGEC."</td><td>\n";
...
{
    global $xoopsDB, $xoopsUser, $xoopsModule, $myts, $eh;
