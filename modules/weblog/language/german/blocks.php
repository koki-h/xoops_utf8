<?php
/*
 * $Id: blocks.php,v 1.3 2005/05/06 18:53:29 tohokuaiki Exp $
...
define('_MB_RECENT_EDIT_NUMBER_OF_ENTRIES','Anzahl der anzuzeigenden Eintr&auml;ge');
define('_MB_WEBLOG_EDIT_LINK_TO_LIST', 'Link authors to their entries? (0=No,1=Yes)'); //eng
define('_MB_RECENT_EDIT_MAX_TITLE_LENGTH','Maximale L&auml;nge des Titels');
define('_MB_RECENT_EDIT_DATE_FORMAT','Datum-Format');
define('_MB_RECENT_EDIT_USE_AVATARS','Avatare benutzen? (0 = Nein, 1 = Ja)');
define('_MB_RECENT_EDIT_TYPE','Typ (1 = Klein, 2 = Mittel, 3 = Gro&szlig;)');
