<?php
/**
 * $Id: modinfo.php,v 1.15 2005/08/14 06:15:44 tohokuaiki Exp $
...
define('_MI_WEBLOG_PRIVMANAGER', 'Privileges(weBLog simple)');
define('_MI_WEBLOG_MYGROUPSADMIN', 'Privileges(XOOPS standard)');
