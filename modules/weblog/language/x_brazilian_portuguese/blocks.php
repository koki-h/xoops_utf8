...
define('_MB_RECENT_EDIT_NUMBER_OF_ENTRIES','Número de entradas a ser mostrado');
define('_MB_WEBLOG_EDIT_LINK_TO_LIST', 'Link authors to their entries? (0=No,1=Yes)'); //eng
define('_MB_RECENT_EDIT_MAX_TITLE_LENGTH','Tamanho máximo do titulo');
define('_MB_RECENT_EDIT_DATE_FORMAT','Formato da Data');
define('_MB_RECENT_EDIT_USE_AVATARS','Usar avatars? (0=Não,1=Sim)');
define('_MB_RECENT_EDIT_TYPE','Type (1=pequeno,2=médio,3=Grande)');
